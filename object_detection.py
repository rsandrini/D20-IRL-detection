...
class ObjectDetector:
    ...
    def is_collision(self, rect1, rect2):
        ...
        # Assuming the width and height of the rectangles are fixed for text labels
        w1, h1 = 100, 20  # Adjust these values according to your text size
        w2, h2 = 100, 20  # Adjust these values according to your text size
